...
public class shipsGuest extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
				    shipsGuest frame = new shipsGuest();
	...
	public shipsGuest() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (txtShip.getText().equals("") || txtFood.getText().equals("") || txtBarcode.getText().equals("")
						...
						String message = "Î£Ï…Î¼Ï€Î»Î·Ï�ÏŽÏƒÏ„Îµ Ï„Î± ÎºÎµÎ½Î¬ Ï€ÎµÎ´Î¯Î± ";
		...
		jTable_Show_Ships.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID", "Ship", "Food", "Barcode", "Exp. Date", "Country", "Company", "Quntity"
			}
		));
