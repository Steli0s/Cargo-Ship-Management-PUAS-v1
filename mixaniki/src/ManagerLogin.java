...
public class ManagerLogin extends JFrame {
	...
	public ManagerLogin() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ManagerLogin.class.getResource("")));
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					String Sql = "Select * from Users where username=? and password=? and dipart = 'Manager'";
		...
		label.setIcon(new ImageIcon(ManagerLogin.class.getResource("/img/CSM-LOGO.png")));
