...
public class guestLogin extends JFrame {
	...
	public guestLogin() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(guestLogin.class.getResource("")));
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					String Sql = "Select * from Users where username=? and password=? and dipart = 'Guest'";
		...
		label.setIcon(new ImageIcon(guestLogin.class.getResource("/img/CSM-LOGO.png")));
